...
var SECTIONS = [
  ...
  { id: "emoji", title: "Emoji", scope: "emoji", app: "window" },
...
var ACTIONS = [
  ...
  { id: "composer.linkPreview", label: "The link preview: under the text, above it, or none", keys: ["Ctrl+Shift+L"] },
  ...
  { id: "emoji.left", label: "Move left", keys: ["Left"] },
  { id: "emoji.right", label: "Move right", keys: ["Right"] },
  { id: "emoji.up", label: "Move up", keys: ["Up"] },
  { id: "emoji.down", label: "Move down", keys: ["Down"] },
  { id: "emoji.nextKind", label: "Emoji, symbols, kaomoji: the next", keys: ["Tab"] },
  { id: "emoji.previousKind", label: "Emoji, symbols, kaomoji: the one before", keys: ["Shift+Tab"] },
  { id: "emoji.insert", label: "Put it in the message, or react with it", keys: ["Return", "Enter"] },
  { id: "emoji.tone", label: "Skin tone: none, then lightest to darkest", keys: ["Alt+0", "Alt+1", "Alt+2", "Alt+3", "Alt+4", "Alt+5"] },
  { id: "emoji.forget", label: "Take it out of your recent ones", keys: ["Ctrl+Delete"] },
  { id: "emoji.close", label: "Close", keys: ["Esc"] },
