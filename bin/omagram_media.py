...
# they stay, and the chat plays your own messages from them. (A sent photo is replaced by
# Telegram's copy, which the window downloads, so photos need nothing kept here.)
